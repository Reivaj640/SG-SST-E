...
class SociodemograficaComponent {
    ...
    render() {
        ...
        const viewerUrl = `sociodemografica-viewer.html?company=${encodeURIComponent(this.companyName)}&module=${encodeURIComponent(this.moduleName)}&submodule=${encodeURIComponent(this.submoduleName)}`;
