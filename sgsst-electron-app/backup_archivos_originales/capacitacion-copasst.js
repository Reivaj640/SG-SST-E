...
class CapacitacionCopasstComponent {
    ...
    render() {
        ...
        const viewerUrl = `capacitacion-copasst-viewer.html?company=${encodeURIComponent(this.companyName)}&module=${encodeURIComponent(this.moduleName)}&submodule=${encodeURIComponent(this.submoduleName)}`;
