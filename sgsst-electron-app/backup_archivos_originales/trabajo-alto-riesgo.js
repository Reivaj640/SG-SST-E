...
class TrabajoAltoRiesgoComponent {
    ...
    render() {
        ...
        const viewerUrl = `trabajo-alto-riesgo-viewer.html?company=${encodeURIComponent(this.companyName)}&module=${encodeURIComponent(this.moduleName)}&submodule=${encodeURIComponent(this.submoduleName)}`;
