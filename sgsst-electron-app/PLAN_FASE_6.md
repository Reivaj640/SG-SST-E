# 📋 PLAN PARA LA FASE 6 - Reorganización del Submódulo Comité de Convivencia

## 🎯 Objetivo
Aplicar el mismo proceso exitoso utilizado en los submódulos anteriores al submódulo "Comité de Convivencia".

## 📦 Archivos a Reorganizar
- `comite-convivencia.js` → `modules/recursos/comite-convivencia/comite-convivencia-logic.js`
- `comite-convivencia-viewer.js` → `modules/recursos/comite-convivencia/comite-convivencia-viewer.js`
- `comite-convivencia-viewer.html` → `modules/recursos/comite-convivencia/comite-convivencia-view.html` (si existe)
- `comite-convivencia-viewer.css` → `modules/recursos/comite-convivencia/comite-convivencia-view.css` (si existe)

## 🔄 Proceso a Seguir

### Paso 1: Preparación
1. Crear directorio `modules/recursos/comite-convivencia/`
2. Crear archivo `modules/recursos/comite-convivencia/index.js`
