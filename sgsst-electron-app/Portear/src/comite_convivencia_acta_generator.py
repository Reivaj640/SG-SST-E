...
def main(temp_data_path, output_path):
    ...
    """
    try:
        log_message("Iniciando generación de acta de Comité de Convivencia...")
...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 3:
        log_message("Uso: python comite_convivencia_acta_generator.py <ruta_json_temporal> <ruta_salida_excel>", "ERROR")
        sys.exit(1)
