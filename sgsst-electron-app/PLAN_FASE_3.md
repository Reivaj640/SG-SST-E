# 📋 PLAN PARA LA FASE 3 - Reorganización del Submódulo Afiliación

## 🎯 Objetivo
Aplicar el mismo proceso exitoso utilizado en los submódulos anteriores al submódulo "Afiliación".

## 📦 Archivos a Reorganizar
- `afiliacion-component.js` → `modules/recursos/afiliacion/afiliacion-logic.js`
- `afiliacion-viewer.js` → `modules/recursos/afiliacion/afiliacion-viewer.js`
- `afiliacion-viewer.html` → `modules/recursos/afiliacion/afiliacion-view.html`
- `afiliacion-viewer.css` → `modules/recursos/afiliacion/afiliacion-view.css`

## 🔄 Proceso a Seguir

### Paso 1: Preparación
1. Crear directorio `modules/recursos/afiliacion/`
2. Crear archivo `modules/recursos/afiliacion/index.js`
