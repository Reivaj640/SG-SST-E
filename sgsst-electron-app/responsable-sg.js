...
class ResponsableSgComponent {
    ...
    render() {
        ...
        const viewerUrl = `responsable-sg-viewer.html?company=${encodeURIComponent(this.companyName)}&module=${encodeURIComponent(this.moduleName)}&submodule=${encodeURIComponent(this.submoduleName)}`;
