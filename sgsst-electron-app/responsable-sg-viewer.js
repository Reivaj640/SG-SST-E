...
async function selectDocument(doc) {
    try {
        ...
        console.log(`[responsable-sg-viewer.js][selectDocument] Documento seleccionado: ${doc.name}, Path: ${doc.path}, Extensión: ${extension}`);
...
async function loadPDF(filePath) {
    console.log(`[responsable-sg-viewer.js][loadPDF] Solicitando previsualización de PDF para: ${filePath}`);
    try {
...
async function loadExcel(filePath) {
    console.log(`[responsable-sg-viewer.js][loadExcel] Solicitando previsualización de Excel para: ${filePath}`);
    try {
...
async function loadWord(filePath) {
    console.log(`[responsable-sg-viewer.js][loadWord] Solicitando previsualización de Word para: ${filePath}`);
    try {
