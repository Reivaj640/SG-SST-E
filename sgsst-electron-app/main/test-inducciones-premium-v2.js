...
has(html, 'HTML: token caché v9-strip-layout-fix', /INDUCCIONES-20260915-v9-strip-layout-fix/);
...
// --- index.html: tokens ---
has(indexHtml, 'index: token logic.js', /inducciones-logic\.js\?v=INDUCCIONES-20260915-v9-strip-layout-fix/);
has(indexHtml, 'index: token viewer.js', /inducciones-viewer\.js\?v=INDUCCIONES-20260915-v9-strip-layout-fix/);
