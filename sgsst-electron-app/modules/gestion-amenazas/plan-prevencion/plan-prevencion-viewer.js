/* ═══════════════════════════════════════════════════════════════════
   K+AIR · 5.1.1 Plan de Prevencion de Emergencias · Visualizador v2.0
   ...
   - Logging estructurado [K+AIRSST][PLAN_PREVENCION][ACCION][STATUS]
   ...
   - Handlers en renderer.js y plan-prevencion-logic.js SIN MODIFICAR
   - main.js, preload.js SIN MODIFICAR

   ═══════════════════════════════════════════════════════════════════ */

var PlanPrevencionViewer = (function () {
    'use strict';
    ...
    /* ═══════════════════════════════════════════════════════════════
       CONSTANTES
       ═══════════════════════════════════════════════════════════════ */
    var _LOG_PREFIX = '[K+AIRSST][PLAN_PREVENCION]';
    ...
    function _expandFileViewer(filePath) {
        if (!filePath) return;
        try {
            window.top.postMessage({ type: 'open-file-viewer-modal', filePath: filePath, source: 'plan-prevencion' }, '*');
        } catch (e) {
    ...
    window.PlanPrevencionViewerGoUp = _goUpLevel;
    window.PlanPrevencionViewerResetToRoot = _navigateToRoot;
    window.PlanPrevencionViewerShowToast = _showToast;
    window.PlanPrevencionViewerShowConfirm = _showConfirmModal;
    window.PlanPrevencionViewerHideConfirm = _hideConfirmModal;
...
window.PlanPrevencionViewer = PlanPrevencionViewer;

/* ═══════════════════════════════════════════════════════════════════
   AUTO-INIT AL CARGAR EL DOM
   ═══════════════════════════════════════════════════════════════════ */
document.addEventListener('DOMContentLoaded', function () {
    PlanPrevencionViewer.init();
});
