// planes-logic.js - Componente para el submódulo "7.1.4 Planes de Mejoramiento — Autoridades y ARL"
...
class PlanesComponent {
    ...
    render() {
        ...
        const viewerUrl = `modules/mejoramiento/planes-mejoramiento/planes-view.html?company=${encodeURIComponent(this.companyName)}&module=${encodeURIComponent(this.moduleName)}&submodule=${encodeURIComponent(this.submoduleName)}`;
    ...
    async handleStandardRequest(event, apiFunctionName) {
        ...
        try {
            ...
            console.error(`[PlanesLogic] Error en ${apiFunctionName}:`, error);
