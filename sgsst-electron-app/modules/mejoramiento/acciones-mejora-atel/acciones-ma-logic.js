// acciones-ma-logic.js - Componente para el submódulo "7.1.3 Acciones de Mejora — AT y EL"

class AccionesMaComponent {
    ...
    render() {
        ...
        const viewerUrl = `modules/mejoramiento/acciones-mejora-atel/acciones-ma-view.html?company=${encodeURIComponent(this.companyName)}&module=${encodeURIComponent(this.moduleName)}&submodule=${encodeURIComponent(this.submoduleName)}`;
    ...
    async handleStandardRequest(event, apiFunctionName) {
        ...
        try {
            ...
            console.error(`[AccionesMaLogic] Error en ${apiFunctionName}:`, error);
...
window.AccionesMaComponent = AccionesMaComponent;
