/* ═══════════════════════════════════════════════════════════════════
   K+AIR · 1.1.1 Responsable del SG-SST · Visualizador v2.0
   v2.0 · 2026-07-10 — Rediseño Opción C (híbrido incremental)
   ═══════════════════════════════════════════════════════════════════
   ...
   - Logging estructurado [K+AIRSST][DOCS][ACCION][STATUS]

   MIGRACIÓN v1.1.1 → v2.0:
   ...
   - Handlers en renderer.js y responsable-sg-logic.js SIN MODIFICAR
   - main.js, preload.js SIN MODIFICAR

   ═══════════════════════════════════════════════════════════════════ */

var ResponsableSgViewer = (function () {
    'use strict';
    ...
    window.responsableSgViewerGoUp = _goUpLevel;
    window.responsableSgViewerResetToRoot = _navigateToRoot;
    window.responsableSgViewerShowToast = _showToast;
    window.responsableSgViewerShowConfirm = _showConfirmModal;
    window.responsableSgViewerHideConfirm = _hideConfirmModal;
...
window.ResponsableSgViewer = ResponsableSgViewer;

/* ═══════════════════════════════════════════════════════════════════
   AUTO-INIT AL CARGAR EL DOM
   ═══════════════════════════════════════════════════════════════════ */
document.addEventListener('DOMContentLoaded', function () {
    ResponsableSgViewer.init();
});
