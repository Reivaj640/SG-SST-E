/* ═══════════════════════════════════════════════════════════════════
   K+AIR · 1.1.8 Conformación del Comité de Convivencia · Visualizador v2.0
   ...
   - Logging estructurado [K+AIRSST][COMITE_CONVIVENCIA][ACCION][STATUS]
   ...
   - Handlers en renderer.js y comite-convivencia-logic.js SIN MODIFICAR
   - main.js, preload.js SIN MODIFICAR

   ═══════════════════════════════════════════════════════════════════ */

var ComiteConvivenciaViewer = (function () {
    'use strict';
    ...
    /* ═══════════════════════════════════════════════════════════════
       CONSTANTES
       ═══════════════════════════════════════════════════════════════ */
    var _LOG_PREFIX = '[K+AIRSST][COMITE_CONVIVENCIA]';
    ...
    window.ComiteConvivenciaViewerGoUp = _goUpLevel;
    window.ComiteConvivenciaViewerResetToRoot = _navigateToRoot;
    window.ComiteConvivenciaViewerShowToast = _showToast;
    window.ComiteConvivenciaViewerShowConfirm = _showConfirmModal;
    window.ComiteConvivenciaViewerHideConfirm = _hideConfirmModal;
...
window.ComiteConvivenciaViewer = ComiteConvivenciaViewer;

/* ═══════════════════════════════════════════════════════════════════
   AUTO-INIT AL CARGAR EL DOM
   ═══════════════════════════════════════════════════════════════════ */
document.addEventListener('DOMContentLoaded', function () {
    ComiteConvivenciaViewer.init();
});
