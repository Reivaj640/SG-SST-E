/* ═══════════════════════════════════════════════════════════════════
   K+AIR · 1.1.6 Conformación del COPASST · Visualizador v2.0
   ...
   - Logging estructurado [K+AIRSST][COPASST][ACCION][STATUS]
   ...
   - Handlers en renderer.js y copasst-logic.js SIN MODIFICAR
   - main.js, preload.js SIN MODIFICAR

   ═══════════════════════════════════════════════════════════════════ */

var CopasstViewer = (function () {
    'use strict';
    ...
    /* ═══════════════════════════════════════════════════════════════
       CONSTANTES
       ═══════════════════════════════════════════════════════════════ */
    var _LOG_PREFIX = '[K+AIRSST][COPASST]';
    ...
    window.CopasstViewerGoUp = _goUpLevel;
    window.CopasstViewerResetToRoot = _navigateToRoot;
    window.CopasstViewerShowToast = _showToast;
    window.CopasstViewerShowConfirm = _showConfirmModal;
    window.CopasstViewerHideConfirm = _hideConfirmModal;
...
window.CopasstViewer = CopasstViewer;
