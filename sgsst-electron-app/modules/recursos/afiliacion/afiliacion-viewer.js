/* ═══════════════════════════════════════════════════════════════════
   K+AIR · 1.1.4 Afiliación al Sistema de Seguridad Social · Visualizador v2.0
   ...
   - Logging estructurado [K+AIRSST][AFILIACION][ACCION][STATUS]
   ...
   - Handlers en renderer.js y afiliacion-logic.js SIN MODIFICAR
   - main.js, preload.js SIN MODIFICAR

   ═══════════════════════════════════════════════════════════════════ */

var AfiliacionViewer = (function () {
    'use strict';
    ...
    /* ═══════════════════════════════════════════════════════════════
       CONSTANTES
       ═══════════════════════════════════════════════════════════════ */
    var _LOG_PREFIX = '[K+AIRSST][AFILIACION]';
    ...
    window.AfiliacionViewerGoUp = _goUpLevel;
    window.AfiliacionViewerResetToRoot = _navigateToRoot;
    window.AfiliacionViewerShowToast = _showToast;
    window.AfiliacionViewerShowConfirm = _showConfirmModal;
    window.AfiliacionViewerHideConfirm = _hideConfirmModal;
...
window.AfiliacionViewer = AfiliacionViewer;

/* ═══════════════════════════════════════════════════════════════════
   AUTO-INIT AL CARGAR EL DOM
   ═══════════════════════════════════════════════════════════════════ */
document.addEventListener('DOMContentLoaded', function () {
    AfiliacionViewer.init();
});
