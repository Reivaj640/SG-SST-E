/* ═══════════════════════════════════════════════════════════════════
   K+AIR · 1.1.7 Capacitación al COPASST · Visualizador v2.0
   ...
   - Logging estructurado [K+AIRSST][CAPACITACION_COPASST][ACCION][STATUS]
   ...
   - Handlers en renderer.js y capacitacion-copasst-logic.js SIN MODIFICAR
   - main.js, preload.js SIN MODIFICAR

   ═══════════════════════════════════════════════════════════════════ */

var CapacitacionCopasstViewer = (function () {
    'use strict';
    ...
    /* ═══════════════════════════════════════════════════════════════
       CONSTANTES
       ═══════════════════════════════════════════════════════════════ */
    var _LOG_PREFIX = '[K+AIRSST][CAPACITACION_COPASST]';
    ...
    window.CapacitacionCopasstViewerGoUp = _goUpLevel;
    window.CapacitacionCopasstViewerResetToRoot = _navigateToRoot;
    window.CapacitacionCopasstViewerShowToast = _showToast;
    window.CapacitacionCopasstViewerShowConfirm = _showConfirmModal;
    window.CapacitacionCopasstViewerHideConfirm = _hideConfirmModal;
...
window.CapacitacionCopasstViewer = CapacitacionCopasstViewer;

/* ═══════════════════════════════════════════════════════════════════
   AUTO-INIT AL CARGAR EL DOM
   ═══════════════════════════════════════════════════════════════════ */
document.addEventListener('DOMContentLoaded', function () {
    CapacitacionCopasstViewer.init();
});
