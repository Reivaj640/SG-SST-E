...
class CapacitacionCopasstComponent {
    ...
    render() {
        ...
        const viewerUrl = `modules/recursos/capacitacion-copasst/capacitacion-copasst-view.html?company=${encodeURIComponent(this.companyName)}&module=${encodeURIComponent(this.moduleName)}&submodule=${encodeURIComponent(this.submoduleName)}`;
    ...
    handleIframeMessage(event) {
        ...
        if (event.data.type === 'open-file-viewer-modal') {
            ...
            if (window.kairFV && typeof window.kairFV.openWithFileViewerFromPath === 'function') {
                ...
                console.warn('[CapacitacionCopasstLogic] kairFV.openWithFileViewerFromPath no disponible');
            }
            return;
        }
...
window.CapacitacionCopasstComponent = CapacitacionCopasstComponent;