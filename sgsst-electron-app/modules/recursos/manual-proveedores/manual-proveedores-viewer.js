/* ═══════════════════════════════════════════════════════════════════
   K+AIR · 1.2.4 Manual de SST para Proveedores y Contratistas · Visualizador v2.0
   ...
   - Logging estructurado [K+AIRSST][MANUAL_PROVEEDORES][ACCION][STATUS]
   ...
   - Handlers en renderer.js y manual-proveedores-logic.js SIN MODIFICAR
   - main.js, preload.js SIN MODIFICAR

   ═══════════════════════════════════════════════════════════════════ */

var ManualProveedoresViewer = (function () {
    'use strict';
    ...
    /* ═══════════════════════════════════════════════════════════════
       CONSTANTES
       ═══════════════════════════════════════════════════════════════ */
    var _LOG_PREFIX = '[K+AIRSST][MANUAL_PROVEEDORES]';
    ...
    window.ManualProveedoresViewerGoUp = _goUpLevel;
    window.ManualProveedoresViewerResetToRoot = _navigateToRoot;
    window.ManualProveedoresViewerShowToast = _showToast;
    window.ManualProveedoresViewerShowConfirm = _showConfirmModal;
    window.ManualProveedoresViewerHideConfirm = _hideConfirmModal;
...
window.ManualProveedoresViewer = ManualProveedoresViewer;

/* ═══════════════════════════════════════════════════════════════════
   AUTO-INIT AL CARGAR EL DOM
   ═══════════════════════════════════════════════════════════════════ */
document.addEventListener('DOMContentLoaded', function () {
    ManualProveedoresViewer.init();
});
