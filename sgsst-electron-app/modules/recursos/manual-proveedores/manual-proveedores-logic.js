// manual-proveedores.js - Componente para el submódulo "1.2.4 Manual de SST para Proveedores y Contratistas"

class ManualProveedoresComponent {
    ...
    render() {
        ...
        const viewerUrl = `modules/recursos/manual-proveedores/manual-proveedores-view.html?company=${encodeURIComponent(this.companyName)}&module=${encodeURIComponent(this.moduleName)}&submodule=${encodeURIComponent(this.submoduleName)}`;
...
window.ManualProveedoresComponent = ManualProveedoresComponent;
