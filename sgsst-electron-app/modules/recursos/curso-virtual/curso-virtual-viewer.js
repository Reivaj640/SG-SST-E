/* ═══════════════════════════════════════════════════════════════════
   K+AIR · 1.2.3 Curso Virtual 50 Horas · Visualizador v2.0
   ...
   - Logging estructurado [K+AIRSST][CURSO_VIRTUAL][ACCION][STATUS]
   ...
   - Handlers en renderer.js y curso-virtual-logic.js SIN MODIFICAR
   - main.js, preload.js SIN MODIFICAR

   ═══════════════════════════════════════════════════════════════════ */

var CursoVirtualViewer = (function () {
    'use strict';
    ...
    /* ═══════════════════════════════════════════════════════════════
       CONSTANTES
       ═══════════════════════════════════════════════════════════════ */
    var _LOG_PREFIX = '[K+AIRSST][CURSO_VIRTUAL]';
    ...
    window.CursoVirtualViewerGoUp = _goUpLevel;
    window.CursoVirtualViewerResetToRoot = _navigateToRoot;
    window.CursoVirtualViewerShowToast = _showToast;
    window.CursoVirtualViewerShowConfirm = _showConfirmModal;
    window.CursoVirtualViewerHideConfirm = _hideConfirmModal;
...
window.CursoVirtualViewer = CursoVirtualViewer;

/* ═══════════════════════════════════════════════════════════════════
   AUTO-INIT AL CARGAR EL DOM
   ═══════════════════════════════════════════════════════════════════ */
document.addEventListener('DOMContentLoaded', function () {
    CursoVirtualViewer.init();
});
