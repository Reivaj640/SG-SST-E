/* ═══════════════════════════════════════════════════════════════════
   K+AIR · 4.1.1 Metodologia IPEVR · Visualizador v2.0
   ...
   - Logging estructurado [K+AIRSST][METODOLOGIA_IPEVR][ACCION][STATUS]
   ...
   - Handlers en renderer.js y metodologia-ipevr-logic.js SIN MODIFICAR
   - main.js, preload.js SIN MODIFICAR

   ═══════════════════════════════════════════════════════════════════ */

var MetodologiaIpevrViewer = (function () {
    'use strict';
    ...
    /* ═══════════════════════════════════════════════════════════════
       CONSTANTES
       ═══════════════════════════════════════════════════════════════ */
    var _LOG_PREFIX = '[K+AIRSST][METODOLOGIA_IPEVR]';
    ...
    function _expandFileViewer(filePath) {
        if (!filePath) return;
        try {
            window.top.postMessage({ type: 'open-file-viewer-modal', filePath: filePath, source: 'metodologia-ipevr' }, '*');
        } catch (e) {
    ...
    window.MetodologiaIpevrViewerGoUp = _goUpLevel;
    window.MetodologiaIpevrViewerResetToRoot = _navigateToRoot;
    window.MetodologiaIpevrViewerShowToast = _showToast;
    window.MetodologiaIpevrViewerShowConfirm = _showConfirmModal;
    window.MetodologiaIpevrViewerHideConfirm = _hideConfirmModal;
...
window.MetodologiaIpevrViewer = MetodologiaIpevrViewer;

/* ═══════════════════════════════════════════════════════════════════
   AUTO-INIT AL CARGAR EL DOM
   ═══════════════════════════════════════════════════════════════════ */
document.addEventListener('DOMContentLoaded', function () {
    MetodologiaIpevrViewer.init();
});
