...
function callParentAPI(type, payload) {
 console.log(`[metodologia-ipevr-viewer.js][callParentAPI] Enviando solicitud al padre. Tipo: ${type}, Payload:`, payload);
 ...
 console.log(`[metodologia-ipevr-viewer.js][callParentAPI] Respuesta recibida del padre para requestId ${requestId}. Success: ${response.payload && response.payload.success}`);

 if (response.payload && response.payload.success) {
 resolve(response.payload);
 } else {
 const errorMessage = (response.payload && response.payload.error) || 'Unknown error from parent process';
 console.error(`[metodologia-ipevr-viewer.js][callParentAPI] Error recibido para la solicitud '${type}':`, errorMessage);
 ...
 console.log(`VIEWER: Sending message to parent: ${type}-request`, { payload, requestId });
...
async function selectDocument(doc) {
 ...
 console.log(`[metodologia-ipevr-viewer.js][selectDocument] Documento seleccionado: ${doc.name}, Extensión: ${extension}`);
