...
(function (global) {
  ...
  function FormExtintores(root, ctx) {
    ...
    function save() {
      ...
      var payload = { type: "extintores", date: state.date, performedBy: state.performedBy, role: state.role, site: state.site, observations: state.observations, status: "Completada", data: state.data };
