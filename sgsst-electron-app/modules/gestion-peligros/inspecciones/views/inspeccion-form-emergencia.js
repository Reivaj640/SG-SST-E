...
(function (global) {
  ...
  function FormEmergencia(root, ctx) {
    ...
    function save() {
      ...
      var payload = { type: "equipos_emergencia", date: state.date, performedBy: state.performedBy, role: state.role, site: state.site, observations: state.observations, status: "Completada", data: state.data, companyId: store.companyId, companyName: store.companyName };
