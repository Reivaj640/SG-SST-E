/* ═══════════════════════════════════════════════════════════════════
   K+AIR · 3.1.6 Restricciones Medicas · Visualizador v2.0
   ...
   - Logging estructurado [K+AIRSST][RESTRICCIONES][ACCION][STATUS]
   ...
   - Handlers en renderer.js y restricciones-logic.js SIN MODIFICAR
   - main.js, preload.js SIN MODIFICAR

   ═══════════════════════════════════════════════════════════════════ */

var RestriccionesViewer = (function () {
    'use strict';
    ...
    /* ═══════════════════════════════════════════════════════════════
       CONSTANTES
       ═══════════════════════════════════════════════════════════════ */
    var _LOG_PREFIX = '[K+AIRSST][RESTRICCIONES]';
    ...
    window.RestriccionesViewerGoUp = _goUpLevel;
    window.RestriccionesViewerResetToRoot = _navigateToRoot;
    window.RestriccionesViewerShowToast = _showToast;
    window.RestriccionesViewerShowConfirm = _showConfirmModal;
    window.RestriccionesViewerHideConfirm = _hideConfirmModal;
...
window.RestriccionesViewer = RestriccionesViewer;

/* ═══════════════════════════════════════════════════════════════════
   AUTO-INIT AL CARGAR EL DOM
   ═══════════════════════════════════════════════════════════════════ */
document.addEventListener('DOMContentLoaded', function () {
    RestriccionesViewer.init();
});
