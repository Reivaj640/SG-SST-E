/* ═══════════════════════════════════════════════════════════════════
   K+AIR · 3.1.4 Evaluaciones Medicas · Visualizador v2.0
   ...
   - Logging estructurado [K+AIRSST][EVALUACIONES_MEDICAS][ACCION][STATUS]
   ...
   - Handlers en renderer.js y evaluaciones-logic.js SIN MODIFICAR
   - main.js, preload.js SIN MODIFICAR

   ═══════════════════════════════════════════════════════════════════ */

var EvaluacionesViewer = (function () {
    'use strict';
    ...
    /* ═══════════════════════════════════════════════════════════════
       CONSTANTES
       ═══════════════════════════════════════════════════════════════ */
    var _LOG_PREFIX = '[K+AIRSST][EVALUACIONES_MEDICAS]';
    ...
    window.EvaluacionesViewerGoUp = _goUpLevel;
    window.EvaluacionesViewerResetToRoot = _navigateToRoot;
    window.EvaluacionesViewerShowToast = _showToast;
    window.EvaluacionesViewerShowConfirm = _showConfirmModal;
    window.EvaluacionesViewerHideConfirm = _hideConfirmModal;
...
window.EvaluacionesViewer = EvaluacionesViewer;

/* ═══════════════════════════════════════════════════════════════════
   AUTO-INIT AL CARGAR EL DOM
   ═══════════════════════════════════════════════════════════════════ */
document.addEventListener('DOMContentLoaded', function () {
    EvaluacionesViewer.init();
});
