/* ═══════════════════════════════════════════════════════════════════
   K+AIR · 3.1.1 Descripcion Sociodemografica · Visualizador v2.0
   ...
   - Logging estructurado [K+AIRSST][SOCIODEMOGRAFICA][ACCION][STATUS]
   ...
   - Handlers en renderer.js y sociodemografica-logic.js SIN MODIFICAR
   - main.js, preload.js SIN MODIFICAR

   ═══════════════════════════════════════════════════════════════════ */

var SociodemograficaViewer = (function () {
    'use strict';
    ...
    /* ═══════════════════════════════════════════════════════════════
       CONSTANTES
       ═══════════════════════════════════════════════════════════════ */
    var _LOG_PREFIX = '[K+AIRSST][SOCIODEMOGRAFICA]';
    ...
    window.SociodemograficaViewerGoUp = _goUpLevel;
    window.SociodemograficaViewerResetToRoot = _navigateToRoot;
    window.SociodemograficaViewerShowToast = _showToast;
    window.SociodemograficaViewerShowConfirm = _showConfirmModal;
    window.SociodemograficaViewerHideConfirm = _hideConfirmModal;
...
window.SociodemograficaViewer = SociodemograficaViewer;

/* ═══════════════════════════════════════════════════════════════════
   AUTO-INIT AL CARGAR EL DOM
   ═══════════════════════════════════════════════════════════════════ */
document.addEventListener('DOMContentLoaded', function () {
    SociodemograficaViewer.init();
});
