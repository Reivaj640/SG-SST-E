/* ═══════════════════════════════════════════════════════════════════
   K+AIR · 2.1.1 Politica del SG-SST · Visualizador v2.0
   ...
   - Logging estructurado [K+AIRSST][POLITICA][ACCION][STATUS]
   ...
   - Handlers en renderer.js y politica-logic.js SIN MODIFICAR
   - main.js, preload.js SIN MODIFICAR

   ═══════════════════════════════════════════════════════════════════ */

var PoliticaViewer = (function () {
    'use strict';
    ...
    /* ═══════════════════════════════════════════════════════════════
       CONSTANTES
       ═══════════════════════════════════════════════════════════════ */
    var _LOG_PREFIX = '[K+AIRSST][POLITICA]';
    ...
    window.PoliticaViewerGoUp = _goUpLevel;
    window.PoliticaViewerResetToRoot = _navigateToRoot;
    window.PoliticaViewerShowToast = _showToast;
    window.PoliticaViewerShowConfirm = _showConfirmModal;
    window.PoliticaViewerHideConfirm = _hideConfirmModal;
...
window.PoliticaViewer = PoliticaViewer;
